...
![Keystone Logo](/assets/Keystone/keystone-logo.png){: width="666" height="130" } 
_Keystone_
...
![Keystone Arch](/assets/Keystone/keystone_overview.webp){: width="800" height="350" } 
_Keystone Arch_
...
![Software Architecture](/assets/Keystone/Snipaste_2025-10-13_19-27-45.png){: width="666" height="200" } 
...
5. **bootrom**：启动固件，为了支持安全启动，在从rom启动过程中，生成相应的密钥。
